...
#define CONFIG_TFT_BACKLIGHT_PIN 33
#define CONFIG_SPI_MOSI 12
#define CONFIG_SPI_MISO 13
#define CONFIG_SPI_CLOCK 14
#define CONFIG_TFT_CS_PIN 15
#define CONFIG_TFT_DC_PIN 27
#define CONFIG_TFT_RESET_PIN 2
